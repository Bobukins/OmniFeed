...
Система автоматически сканирует ваших конкурентов и потенциальных партнеров, используя 3 ключевых фильтра: географическую близость, вовлеченность аудитории и эмоциональный фон обсуждений (нейросеть выделяет аккаунты с негативными отзывами). Приложение имеет подробную статистику на основе соцсетей и показывает метрики вовлеченности и эффективности рекламной компании. Дает рекомендации по продвижению с учетом разных трендов на разных платформах 
Особенности:
...
- Система раннего оповещения о трендах и проблемных упоминаниях
 ...
 - Рекомендуем когда лучше публиковать контет для каждой из площадок 
...
Технологическое решение: Фронтенд -  js, css, mysql, react.js, material-UI, REST API, JWT, OAuth. Девопс - git, docker, kubernetes, nginx ingress controller, helm, yandexcloud (микросервисная архитектура). Бекенд – python: numpy, pandas, selenium, scikit-learn, catboost, tensorflow, optuna, fastapi, schedule, Janitor
...
Анреенко Иван – frontend developer, designer
